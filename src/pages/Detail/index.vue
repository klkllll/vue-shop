        ...
        <div class="fitting">
          ...
          <div class="good-suits">
            ...
            <div class="result">
              ...
              <button class="addshopcar" @click="addToCart">加入购物车</button>
            </div>
          </div>
        </div>
        <div class="intro">
...
export default {
  ...
  mounted() {
    console.log("detail", this.$route.params.skuId);
  ...
  methods: {
    changeActive(saleAttrValue, arr) {
      ...
      if (saleAttrValue.saleAttrName == "颜色") {
        this.skuInfo.skuSaleAttrValueList[0].saleAttrValueName =
          saleAttrValue.saleAttrValueName;
      } else if (saleAttrValue.saleAttrName == "版本") {
        this.skuInfo.skuSaleAttrValueList[0].saleAttrValueName =
          saleAttrValue.saleAttrValueName;
      }
    },
    ...
    async addToCart() {
      try {
        let result = await this.$store.dispatch("addOrUpdateCartList", {
