  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ nowDefaultAddress.fullAddress }}</span>
        收货人：<span>{{ nowDefaultAddress.consignee }}</span>
        <span>{{ nowDefaultAddress.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  mounted() {
    ...
    // 获取订单详细页信息
    this.$store.dispatch("getUserTrade");
  },
  computed: {
    ...mapState({
      addressInfo: (state) => {
  ...
  methods: {
    ...
    async toPay() {
      ...
      let data = {
        consignee: this.nowDefaultAddress.consignee,
        consigneeTel: this.nowDefaultAddress.phoneNum,
        deliveryAddress: this.nowDefaultAddress.fullAddress,
        paymentWay: "ONLINE",
        orderComment: this.description,
